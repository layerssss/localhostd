class Bnb extends React.Component {
  ...
  componentDidMount() {
    ...
    var initSocket = () => {
      ...
      this.socket.onmessage = messageEvent => {
        var { state, message, terminalOutput } = JSON.parse(messageEvent.data);
        ...
        if (terminalOutput) {
          ...
          this.terminalHistory[terminalOutput.applicationName].push(
            terminalOutput.dataString
          );
        }
      };
  ...
  render() {
    var activeApplication = this.state.applications[
      this.state.activeApplicationIndex
    ];
            ...
            this.state.creatingApplication
              ? createElement(
                  ...
                  createElement(
                    ApplicationForm,
                    {
                      application: {
                        dir:
                          this.state.env["HOME"] || this.state.env["HOMEPATH"],
              ...
              : activeApplication
                    ...
                    createElement(
                      ...
                      createElement(
                        ...
                        createElement(
                          ...
                          {
                            onClick: () =>
                              OpenUrl(`http://${activeApplication.name}.dev`)
                          },
                          createElement("span", {
                        ...
                        createElement(
                          Button,
                          {
                            disabled:
                              ...
                              !activeApplication.running,
                            onClick: () =>
                              this.doAction("RestartApplication", {
                                applicationName: activeApplication.name
                              })
                          },
                          createElement("span", {
                          ...
                          createElement(
                            ...
                            createElement(
                              Button,
                              {
                                bsStyle: "danger",
                                onClick: () =>
                                  this.doAction("DeleteApplication", {
                                    applicationName: activeApplication.name
                                  })
                              },
                              "Delete"
                        ...
                        createElement(
                          ...
                          createElement(
                            ...
                            createElement(XTerm, {
                              ...
                              history:
                                this.terminalHistory[activeApplication.name] ||
                                [],
                              onResize: (cols, rows) =>
                ...
                : createElement(
                    ...
                    createElement("p", {}, "Tips:"),
                    createElement(
                      "p",
                      {},
                      `You can use HTTP(S) proxy at http://${this.state.bind}:${
                        this.state.port
                      } to access bnb in your own browser.`
                    ),
                    createElement(
                      "p",
                      {},
                      ...
                      createElement(
                        "a",
                        {
                          ...
                          onClick: () =>
                            OpenBlob(
                              "bnb.ca.crt",
                              new Blob([this.state.caCertificate])
                            )
                        },
                        createElement("span", {
